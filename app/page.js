...
export default function Home() {
    ...
    const baseColors = ["#cc0033", "#00b7e5", "#52b69b"];
    ...
    // TODO uncomment create shade color variations
    ...
    // TODO uncomment create each palette array
    ...
    return (
        <div className="container mx-auto p-4 max-w-4xl">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
                {/*TODO Uncomment after building colors */}
